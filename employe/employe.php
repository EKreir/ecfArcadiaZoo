...
<div class="container">
    ...
    <a class="btn btn-primary mt-3" href="?page=modifier_services">Modifier les services</a>
    <a class="btn btn-primary mt-3" href="?page=enregistrer_consommation">Consommation animal</a>
    <a class="btn btn-primary mt-3" href="?page=messages_contact">Mails reçus</a>
    <a class="btn btn-danger mt-3" href="?page=logout">Se déconnecter</a>
