...
<div class="container">
    ...
    <a class="btn btn-primary mt-3" href="?page=create_report">Créer un compte rendu</a>
    <a class="btn btn-primary mt-3" href="?page=comment_habitat">Commenter un habitat</a>
    <a class="btn btn-primary mt-3" href="?page=give_opinion">Avis sur un animal</a>
